...
ANGSD-wrapper also eases the configuration of ANGSD-related programs such as \tjyk{Fumagali citation doesn't show up properly}\ph{I think the citation is just 'Fumagali' and the link to the webpage. If so, then it works for me -PH}ngsPopGen \citep{ngsPopGen}, ngsF\citep{vieira2013estimating}, and ngsAdmix \citep{pmid24026093}. 

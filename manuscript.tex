...
\begin{center}
    ...
    \hline
    Methods Implemented & Interactive Graphing \\ \hline
    ABBA BABA & Yes \\ \hline
    Admixture & Yes  \\ \hline
    Ancestral Sequence & N/A \\ \hline
    Genotype Likelihoods & N/A \\ \hline
    Inbreeding Coefficients & N/A \\ \hline
    PCA & Yes \\ \hline
    Site Frequency Spectrum & Yes \\ \hline
    Theta Calculation & Yes \\ \hline
    \end{tabular}
...
As a demonstration of analyses in ANGSD-wrapper, we explore patterns of diversity in maize and teosinte. We used resequenced samples from the HapMap2 project \citep{hufford2012comparative} and calculated summary statistics using a 10 megabase region on chromosome 10.

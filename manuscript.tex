...
\caption{Admixture analysis for {\it Zea mays} spp. {\it mays}, {\it Zea mays} spp. {\it parviglumas}, and {\it Zea mays} spp. {mexicana} (\texit{mex}) with K=4 source populations. Individuals are shown in same order as Table \ref{tab:samples}. }
\label{fig:admixture}
\end{figure}

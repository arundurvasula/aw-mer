...
ANGSD uses probabilistic approaches which can directly make use of genotype likelihoods, thus SNP calling is not required for comparative analyses. This takes advantage of all of the sequencing data and producing more accurate results for samples with low sequencing depth.
...
One of the most important features of ANGSD is that analyses can be integrated over per-site genotype likelihoods, rather than on predetermined polymorphic sites \emph{a priori}. 

...
We first use \X\ to estimate the site frequency spectrum (SFS) of both maize and its wild progenitor \textit{Zea mays} ssp. \textit{parviglumis}, assuming an inbreeding coefficient of $F=1$ since these are all highly inbred samples. %\jri{do we worry that fig. 3 not graphs directly from A-W?} % noted this in the figure legend

...
%\begin{figure}
%\centering
%\includegraphics[width=130mm]{theta_rice_chr12.png}
%\caption{A visualization of Watterson's $\theta$ estimated by ANGSD across chromosome 12 of \og using ANGSD-wrapper\label{fig:theta} }%\pjh{capitalized 'ANGSD' in ANGSD-wrapper}
%\end{figure}
